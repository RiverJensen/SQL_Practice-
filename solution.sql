...
-- salespeople in the 'Northwest' region.
 ...
 REPLACE first_name, last_name,email FROM salesFROM salespeople WHERE region = 'Southwest'
...
-- watermelons that cost more than $5.00.
 ...
 SELECT * FROM melons WHERE melon_type = 'Watermelon' AND price >5;
...
-- both the Northwest and Southwest regions.
 ...
 SELECT email FROM salespeople WHERE region = 'Northwast' OR region = 'Southwest';
...
SELECT melon_type, common_name, price, price*.73 AS euro_mellon FROM melons;

-- Problem 14:
-- Task: Write a query that shows the total number of customers in our
-- customer table.

SELECT COUNT(id) FORM customers;
